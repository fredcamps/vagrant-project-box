...
service mysql restart
{
    ...
    mysql -u root -e "CREATE DATABASE gitlabhq_production DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;"
    mysql -u root -e "CREATE USER 'git'@'%' IDENTIFIED BY 'git';"
    mysql -u root -e "GRANT ALL PRIVILEGES ON gitlabhq_production.* TO 'gitlab'@'%';"
} 2> /dev/null
